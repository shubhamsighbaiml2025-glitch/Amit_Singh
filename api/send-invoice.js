...
export default async function handler(req, res) {
  ...
  try {
    ...
    const subject = `Invoice ${invoice.invoiceNumber} - Singh Automobiles Engine Engineering`;
    const message = [
      `Hello ${invoice.customer.name},`,
      `Please find attached your invoice from Singh Automobiles Engine Engineering for heavy machinery service support.`,
